...
export const LeadActions = ({ lead }: LeadActionsProps) => {
  ...
  return (
    ...
    >
      <Dropdown
        trigger={
          <button className='p-1 sm:p-1.5 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 rounded hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors flex-shrink-0 w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center'>
            <svg
